...
إنّ HTML و CSS من أفضل الطرق لتقديم المحتوى وذالك لسهولة تعلمها وقوتها ، لكن فمن الطبيعي ان تجد نواقص في لغة تواجهها وتعجز عن تقديم لك بعض الخدمات لذالك عليك الالتفاف والتعديل عليها قليلا حتي تناسب متطلباتك .
على الرغم من قوة الـHTML و CSS الا انها تجد صعوبة في التعامل مع الهيكلة المعقدة، اذا كان لديك موقع بسيط ولا يحتاج للكثير من التقسيمات فهنا نستطيع التعامل معها بشكل طبيعي لكن في حال كان لدينا الكثير من التقسيمات او لدينا موقع يعرض لنا منتجات كثيره على شكل بطاقات فهذا يعتبر عمل صعب بالنسبة لـHTML و CSS فهنا نلجئ الى احد الحلول :
